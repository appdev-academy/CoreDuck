...
public extension NSManagedObject {
    ...
    */
    ...
    /**
        ...
        - parameter withValue: value for search
        - parameter inContext: context for search
    */
    static func findFirst<Type>(byAttribute attribute: String, withValue value: Type, inContext context: NSManagedObjectContext) -> NSManagedObject? {
    ...
    */
    ...
    /**
        ...
        - parameter withValue: value for search
    */
    static func findFirst<Type>(byAttribute attribute: String, withValue value: Type) -> NSManagedObject? {
        // Build predicate with value
        let predicate = NSPredicate(format: "\(attribute) = \(value)")
